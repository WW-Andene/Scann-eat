...
const STRINGS = {
  fr: {
    ...
    vetoExplain: 'Le produit viole une contrainte dure de votre régime — score personnel ramené à 0. Le détail ci-dessous montre tout ce que l\'analyse a calculé, à titre informatif.',
    todayTitle: "Aujourd'hui",
    clearToday: 'Effacer',
    todayEntries: 'Aliments loggés',
    portionLabel: 'Portion consommée',
    logPortion: 'Logger cette portion',
    dashNoTarget: 'pas de cible (profil incomplet)',
    dashKcal: 'Calories',
    dashSatFat: 'AGS',
...
Cette app est une aide à la décision, pas un avis nutritionniste ou médical. Pour une décision cruciale (allergie, pathologie), confirme avec un professionnel de santé et l'étiquette originale.`,
  ...
  en: {
    ...
    vetoExplain: 'This product violates a hard constraint of your diet — personal score capped at 0. The breakdown below is shown informatively.',
    todayTitle: 'Today',
    clearToday: 'Clear',
    todayEntries: 'Logged foods',
    portionLabel: 'Portion consumed',
    logPortion: 'Log this portion',
    dashNoTarget: 'no target (incomplete profile)',
    dashKcal: 'Calories',
    dashSatFat: 'Sat fat',
